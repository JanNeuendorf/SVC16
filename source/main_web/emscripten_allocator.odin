// Copied from Karl Zylinski's odin-raylib-web template (https://github.com/karl-zylinski/odin-raylib-web).
// Allocator that uses emscripten's malloc/calloc/realloc/free.
// Needed because Odin's default WASM allocator conflicts with emscripten's
// memory management. Supports proper alignment for maps and SIMD.
